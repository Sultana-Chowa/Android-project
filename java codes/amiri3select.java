...
public class amiri3select extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ImageView image;
    TextView priceset;
    Spinner mySpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amiri3select);
        ...
        myfragmenttransection.add(R.id.fragmentcontainer3, new amiri3Fragment()).commit();
    }
